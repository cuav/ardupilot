...
void AP_Hygrometer_UAVCAN::subscribe_msgs(AP_UAVCAN* ap_uavcan)
{
    ...
    printf("AP_Hygrometer_UAVCAN ------hygrometer_listener_res = %d\n",hygrometer_listener_res);
...
bool AP_Hygrometer_UAVCAN::get_humidity(float &humidity)
 {
    ...
    humidity = _humidity;
    printf("AP_Hygrometer_UAVCAN::get_humidity = %f\n",humidity);
    return true;
...
bool AP_Hygrometer_UAVCAN::get_temperature(float &temperature)
{
    ...
    // printf("AP_Hygrometer_UAVCAN::get_temperature = %f\n",temperature);
    return true;
}
...
bool AP_Hygrometer_UAVCAN::get_id(uint8_t &id)
 {
    ...
    id = _id;
    printf("AP_Hygrometer_UAVCAN::get_id = %d\n",id);
    return true;
