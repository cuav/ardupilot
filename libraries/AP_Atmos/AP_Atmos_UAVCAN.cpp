...
UC_REGISTRY_BINDER(Sht31Cb, cuav::equipment::atmos::Sht31);
...
void AP_Atmos_UAVCAN::subscribe_msgs(AP_UAVCAN* ap_uavcan)
{
    ...
    uavcan::Subscriber<cuav::equipment::atmos::Sht31, Sht31Cb> *sht31_listener;
    sht31_listener = new uavcan::Subscriber<cuav::equipment::atmos::Sht31, Sht31Cb>(*node);
